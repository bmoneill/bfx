 ...
 */
void bfx_op_putchar_ascii(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_putchar_number(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_getchar_ascii(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_getchar_number(BFX* bfx, BFX_FileIndex* index) {
    char s[64];
    int  c, i = 0;
 ...
 */
void bfx_op_putchar_register_ascii(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_putchar_register_number(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_add(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_sub(BFX* bfx, BFX_FileIndex* index) {
    BFX_GRIN_DATA->tape[bfx->tp] -= BFX_GRIN_DATA->reg;
}
 ...
 */
void bfx_op_mul(BFX* bfx, BFX_FileIndex* index) {
    BFX_GRIN_DATA->tape[bfx->tp] *= BFX_GRIN_DATA->reg;
}
 ...
 */
void bfx_op_div(BFX* bfx, BFX_FileIndex* index) {
    BFX_GRIN_DATA->tape[bfx->tp] /= BFX_GRIN_DATA->reg;
}
 ...
 */
void bfx_op_exp(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_store(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_load(BFX* bfx, BFX_FileIndex* index) {
    BFX_GRIN_DATA->tape[bfx->tp] = BFX_GRIN_DATA->reg;
}
 ...
 */
void bfx_op_swap(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_zero(BFX* bfx, BFX_FileIndex* index) { BFX_GRIN_DATA->tape[bfx->tp] = 0; }

/**
 * @brief Zero cell at register value (Grin)
 */
void bfx_op_zero_ptr(BFX* bfx, BFX_FileIndex* index) {
 ...
 * @brief Modulo (Grin)
 */
void bfx_op_mod(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_round(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_nand(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_or(BFX* bfx, BFX_FileIndex* index) {
    BFX_GRIN_DATA->tape[bfx->tp]
        = ((int) BFX_GRIN_DATA->tape[bfx->tp]) | ((int) BFX_GRIN_DATA->reg);
}
 ...
 */
void bfx_op_not(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_negate(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_simplify(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_print(BFX* bfx, BFX_FileIndex* index) {
    bfx->ip++;
 ...
 */
void bfx_op_newline(BFX* bfx, BFX_FileIndex* index) { putchar('\n'); }

/**
 * @brief Sine of current cell value (Grin)
 */
void bfx_op_sin(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_cos(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_tan(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_arcsin(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_arccos(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_arctan(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_inv(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_mod2(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_e(BFX* bfx, BFX_FileIndex* index) { BFX_GRIN_DATA->tape[bfx->tp] = M_E; }

/**
 * @brief Set current cell to Pi (Grin)
 */
void bfx_op_pi(BFX* bfx, BFX_FileIndex* index) { BFX_GRIN_DATA->tape[bfx->tp] = M_PI; }

/**
 * @brief Natural logarithm of current cell value (Grin)
 */
void bfx_op_ln(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_mean(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_sqrt(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_log(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_jump(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_toggle_deg_rad(BFX* bfx, BFX_FileIndex* index) {
 ...
 */
void bfx_op_exit(BFX* bfx, BFX_FileIndex* index) { bfx->ip = bfx->program_len; }
